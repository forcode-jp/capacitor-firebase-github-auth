...
var WebView = /** @class */ (function () {
    ...
    WebView.prototype.waitForWebViewContextLoaded = function () {
        ...
        driver.waitUntil(function () {
            ...
            return (currentContexts.length > 1 &&
                currentContexts.find(function (context) { return context.toLowerCase().includes(exports.CONTEXT_REF.WEBVIEW); }));
        }, {
            timeout: 10000,
    ...
    WebView.prototype.switchToContext = function (context) {
        driver.switchContext(this.getCurrentContexts()[context === exports.CONTEXT_REF.WEBVIEW ? 1 : 0]);
    };
    /**
    ...
    WebView.prototype.waitForDocumentFullyLoaded = function () {
        driver.waitUntil(function () { return driver.execute(function () { return document.readyState; }) === DOCUMENT_READY_STATE.COMPLETE; }, {
            timeout: 15000,
