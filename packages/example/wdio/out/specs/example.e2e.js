...
var webview_screen_1 = __importDefault(
  require("../screenobjects/webview.screen")
);
...
describe("Top", function () {
  ...
  it("should hide the text box", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var deviceName;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            webview_screen_1.default.switchToContext(
              WebView_1.CONTEXT_REF.WEBVIEW
            );
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              browser.saveScreenshot("./" + deviceName + ".png"),
            ];
          case 2:
            _a.sent();
            return [2 /*return*/];
